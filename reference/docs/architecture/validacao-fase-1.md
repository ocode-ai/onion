...
#### ✅ Arquivo 1: `${CLAUDE_PLUGIN_ROOT}/reference/utils/clickup-mcp-wrappers.md`
...
#### ✅ Arquivo 2: `${CLAUDE_PLUGIN_ROOT}/reference/docs/strategies/clickup-comment-patterns.md`
...
#### ✅ Arquivo 3: `${CLAUDE_PLUGIN_ROOT}/reference/docs/architecture/desacoplamento-roadmap.md`
...
#### ✅ Arquivo 4: `${CLAUDE_PLUGIN_ROOT}/reference/docs/architecture/acoplamento-clickup-problema-analise.md`
