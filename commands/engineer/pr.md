...
- **Padrão 3 (PR Criada)**: `${CLAUDE_PLUGIN_ROOT}/reference/docs/strategies/clickup-comment-patterns.md`
- **Abstração MCP**: `commentPRCreated()` em `${CLAUDE_PLUGIN_ROOT}/reference/utils/clickup-mcp-wrappers.md` (linhas 632-661)
