...
Este comando analisa o trabalho realizado na sessão atual, organiza a documentação gerada e sincroniza com a estrutura `.claude/sessions/` do projeto, mantendo um histórico organizado de todas as atividades de desenvolvimento.
